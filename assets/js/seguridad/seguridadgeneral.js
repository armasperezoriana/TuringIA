...
var expClaveEspecial =/^[a-zA-ZÀ-ÿ\s]{5,30}$/;
...
if(nombre==""|apellido==""|cedula==""|username==""|rol==""|pass1==""|pass2==""|correo==""|clave_especial==""){
 ...
 $(".errorNombre").html("Debe ingresar su nombre");
   $(".errorApellido").html("Debe ingresar su apellido");
    $(".errorCedula").html("Debe ingresar su ID");
      ...
      $(".errorRol").html("Debe seleccionar su rol");
         $(".errorPass1").html("La contraseña debe tener:<ul> <br> <li> Entre 8 y 16 caracteres. <li> Al menos un dígito.<br> <li> Al menos una minúscula y una mayúscula <br><li>NO puede tener otros símbolos.</ul>");
           $(".errorPass2").html("Confirmar Contraseña");
              ...
              $(".errorClave").html("Debe ingresar el nombre de la compañia a la que pertenece");
           
}

else{
if(!expCedula.test(cedula)){
$(".errorCedula").html("El campo ID no coincide con el formato esperado 7 a 10 numeros");
   rcedula = false;
   return false;
} else {
$(".errorCedula").html("");
rcedula = true;
         $(".errorCedula").html("iD valida");
     ...
     if(!expApellido.test(apellido)){
       ...
       rcorreo = true;
        ...
        $(".errorClave").html("Este campo solo acepta caracteres minimo 5, maximo 30");
           rclave_especial = false;
           return false;
} else {
        $(".errorClave").html("Compañia valida");
...
if(nombre==""|apellido==""|cedula==""|username==""|rol==""|pass1==""|pass2==""|correo==""|clave_especial==""){
     ...
     $(".errorNombreM").html("Debe ingresar su nombre");
       $(".errorApellidoM").html("Debe ingresar su apellido");
        $(".errorCedulaM").html("Debe ingresar su ID");
         $(".errorUsernameM").html("Debe ingresar su nombre de usuario");
          $(".errorRolM").html("Debe seleccionar su rol");
               $(".errorPassM").html("Confirmar Contraseña");
                  ...
                  $(".errorClaveEM").html("Debe ingresar el nombre de la compañia que pertenece");
...
if(!expCedula.test(cedula)){
    $(".errorCedulaM").html("El campo ID no coincide con el formato esperado 7 a 10 numeros");
       rcedula = false;
       return false;
} else {
    $(".errorCedulaM").html("");
   rcedula = true;
             $(".errorCedulaM").html("ID valida");
         ...
         if(!expApellido.test(apellido)){
           ...
           rcorreo = true;
            ...
            $(".errorClaveEM").html("Este campo solo acepta caracteres minimo 5, maximo 30");
               rclave_especial = false;
               return false;
    } else {
